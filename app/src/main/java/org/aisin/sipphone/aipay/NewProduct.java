...
public class NewProduct {
	...
	public static ArrayList<Productinfos> getproducts_ZFB() {
		...
		pcs.add(new Productinfos("直冲", 2, "充50元到账200元", 50, "", true));
		pcs.add(new Productinfos("直冲", 2, "充100元到账500元", 100, "", false));
		pcs.add(new Productinfos("直冲", 2, "充200元到账1000元", 200, "", false));
		pcs.add(new Productinfos("直冲", 2, "充500元到账2500元", 500, "", false));
