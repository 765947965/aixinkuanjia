	...
	public static String[] TutorialTitles(String titleflag) {
		if ("samsung".equals(titleflag)) {
			return new String[] { "1、点击“设置”按钮进入应用管理页面",
					"2、点击右上“更多”按钮进入权限设置页面，找到“应用程序许可”", "3、在应用程序许可中找到“爱信”",
					"4、在应用列表中找到“爱信”，点击勾选" };
