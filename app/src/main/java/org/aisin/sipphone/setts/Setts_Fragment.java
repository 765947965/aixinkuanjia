...
public class Setts_Fragment extends Fragment implements OnClickListener {
    ...
    private RelativeLayout setts_selfinfo_layout;// 个人信息
    private ImageView setts_selfinfo_image;
    private ImageView shouwimageaction;
    private TextView setts_selfinfo_username;
    private TextView setts_logon_userphone;

    private File headiamge;

    private RelativeLayout setts_account_relayout, setts_hy_relayout;
    private RelativeLayout setts_calloutset_relayout;
    private RelativeLayout setts_Keyback_relayout;
    private RelativeLayout setts_recharge_relayout;
    private RelativeLayout setts_wallet_relayout;
    private RelativeLayout setts_Feedback_relayout;
    private RelativeLayout setts_inviteriends_relayout;
    private RelativeLayout setts_aboutaisin_relayout;
    private RelativeLayout setts_red_relayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setts_fragment = inflater.inflate(R.layout.settsactivity, container,
                false);

        setts_selfinfo_layout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_selfinfo_layout);
        setts_hy_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_hy_relayout);
        ...
        setts_account_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_account_relayout);
        setts_calloutset_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_calloutset_relayout);
        setts_Keyback_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_Keyback_relayout);
        setts_recharge_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_recharge_relayout);
        setts_wallet_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_wallet_relayout);
        setts_Feedback_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_Feedback_relayout);
        setts_inviteriends_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_inviteriends_relayout);
        setts_aboutaisin_relayout = (RelativeLayout) setts_fragment
                .findViewById(R.id.setts_aboutaisin_relayout);
        setts_red_relayout = (RelativeLayout) setts_fragment
        ...
        setts_hy_relayout.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.shouwimageaction:
                ...
                return;
            case R.id.setts_hy_relayout:
                intent = new Intent(AisinActivity.context,
                        org.aisin.sipphone.setts.CheckWebView.class);
                intent.putExtra("flag_name", "会员登陆");
                intent.putExtra("url_view", "http://www.m7.hk");
