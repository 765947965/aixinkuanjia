	...
	public int compareTo(Contact another) {
		if (this.F_PY.equals(another.F_PY)) {
			if (this.T_PY.equals(another.T_PY)) {
				 ...
				 * if (this.showflag && another.showflag) { if
				 * (this.remark.equals(another.remark)) { return
				 * this.friendphone.compareTo(another.friendphone); } else {
				 * return this.remark.compareTo(another.remark); } } else if
				 * (this.showflag && !another.showflag) { if
				 * (this.remark.equals(another.remark)) { return
				 * this.friendphone.compareTo(another.phonesList .get(0)); }
				 * else { return this.remark.compareTo(another.remark); } } else
				 * if (!this.showflag && another.showflag) { if
				 * (this.remark.equals(another.remark)) { return
				 * this.phonesList.get(0).compareTo( another.friendphone); }
				 * else { return this.remark.compareTo(another.remark); } } else
				 * if (!this.showflag && !another.showflag) { if
				 * (this.remark.equals(another.remark)) { return
				 * this.phonesList.get(0).compareTo( another.phonesList.get(0));
				 * } else { return this.remark.compareTo(another.remark); } }
				 */
			}
